...
\begin{proof}
	...
	\have[\ ]{c}{\exists \meta{x}\meta{\phi}(\ldots \meta{x} \ldots)} \Ei{a}
\end{proof}
...
\begin{proof}
	...
	\open
		\hypo[i]{b}{\meta{\phi}(\ldots \meta{c} \ldots)} \by{Flag \meta{c}}{}
		\have[j]{c}{\meta{\psi}}
	\close
...
%\begin{multicols}{2}
%\begin{proof}
%	\have[m]{ab}{\forall \meta{x}\enot \meta{\phi}}
%	\have[\ ]{ac}{\enot \exists \meta{x} \meta{\phi}}\cq{ab}
%
%	\have[m]{ab}{\enot \exists \meta{x}  \meta{\phi}}
%\\	\have[\ ]{ac}{\forall \meta{x}\enot\meta{\phi}}\cq{ab}
%\end{proof}
%\begin{proof}
%	\have[m]{ab}{\exists \meta{x}\enot\meta{\phi}}
%	\have[\ ]{ac}{\enot \forall \meta{x} \meta{\phi}}\cq{ab}
%
%	\have[m]{ab}{\enot \forall \meta{x}  \meta{\phi}}
%\\	\have[\ ]{ac}{\exists \meta{x}\enot \meta{\phi}}\cq{ab}
%\end{proof}
%\end{multicols}
%
