...
\noindent \small \copyright \ Michael Rieppel, Tim Button, and P.~D. Magnus 2005--2025
...
\vspace{1ex}
\noindent Thanks to the following for spotting typos, errors, or omissions in earlier versions: Chris Cho, Antonio Freiles, Yasmeen Hembree, Scott Looney, Thiago de Melo, Tong Pan (proof-reader extraordinaire!), Bertie Probyn, Ian York, and Yulun Zeng.
...
\item I've modified the syntax for the first-order language, reordered the presentation of various topics, and revised the practice problems.
\end{itemize}
