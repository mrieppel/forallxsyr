...
\begin{itemize}
\item I've changed the first chapter to more closely reflect my own introductory lecture.  For example, I elucidate the modal notion of validity using possible worlds, and emphasize logic's focus on formal validity a bit more explicitly.
